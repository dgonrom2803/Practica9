...
public class Menu {
    public static void main(String[] args){
        ...
        while(!salir){
            ...
            System.out.println("3. Importar CSV a la base de datos");
            System.out.println("4. Seleccionar alumno aleatorio");
            System.out.println("5. Alumnos con más y menos intervenciones");
            ...
            System.out.println("13. Exportar Base de datos a CSV");
            System.out.println("14. Borra la Base de datos");
            ...
            try {
                ...
                switch (opcion) {
                    ...
                    case 2 -> {
                        ...
                        XMLaBaseDeDatos.xmlABaseDeDatos();
                    }
                    case 3 -> {
                    ...
                    default -> System.out.println("Solo números entre 1 y 15");
                }
